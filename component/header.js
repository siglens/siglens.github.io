(function ($) {
  $.fn.header = function (options) {
    ...
    let prefixTwo = setting.activeBlog == "active" ? "../" : "";
    let prefixTwoPoint = setting.activeBlog == "active" ? ".." : "";
    let prefixOne = setting.activeBlog == "active" ? "." : "";
    let indexPage = setting.activeBlog == "active" ? "../index.html" : "";
    ...
    return this.each(function () {
      ...
      const headerHtml = `
        ...
        <div class="container">
            <a class="navbar-brand " href="${prefixTwo}index.html">
                <div class="d-flex">
                    <div class="pr-1"><img src="${prefixOne}./assets/ss-logo.svg" alt=""></div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item ${setting.activeBlog}">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="${prefixTwoPoint}/guides.html">Guides</a>
                            <a class="dropdown-item" href="${prefixTwoPoint}/questions.html">Questions</a>
                        </div>
                    </li>
                    <li>
                        <a href="${indexPage}#getting-started" id="try-now-btn">Try Now</a>
                    </li>
                    <li>
                        <a href="https://github.com/siglens/siglens" target="_blank">
                            <img src="${prefixTwo}assets/github.svg" width="26" height="26" alt="" />
                        </a>
                    </li>
                </ul>
            </div>
